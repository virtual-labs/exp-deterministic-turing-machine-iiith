...
window.addEventListener('load', function(e){
  ...
  controlsToggle = document.getElementById("dtm-controls-toggle");
  ...
  instructionToggle = document.getElementById("dtm-instructions-toggle");
  ...
  traceToggle = document.getElementById("dtm-stack-trace-toggle");
